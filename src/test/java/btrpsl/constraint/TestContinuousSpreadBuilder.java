...
public class TestContinuousSpreadBuilder {
    ...
    @Test(dataProvider = "badContinuousSpreads", expectedExceptions = {BtrpPlaceVJobBuilderException.class})
    ...
    public void testGoodSignatures(String str, int nbVMs) throws Exception {
        ...
        c.add(new ContinuousSpreadBuilder());
        BtrPlaceVJobBuilder b = new BtrPlaceVJobBuilder(e, c);
        Spread x = (ContinuousSpread) b.build("namespace testContinuousSpreadBuilder; VM[1..10] : tiny;\n" + str).getConstraints().iterator().next();
