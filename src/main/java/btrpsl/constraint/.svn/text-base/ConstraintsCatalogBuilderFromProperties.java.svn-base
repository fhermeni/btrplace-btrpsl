        ...
        if (props.isDefined(CATALOG_CONTENTS_PROPERTIES)) {
            try {
                ...
                for (String constraint : constraints) {
                    ...
                    //c.add((PBPlacementConstraintBuilder) cl.getConstructor(VJobBuilder.class, String.class).newInstance(new Object[]{vJobBuilder, constraint}));
                    c.add((PlacementConstraintBuilder) cl.newInstance());
                }
                BtrPlaceVJobBuilder.LOGGER.debug("Available constraints: " + c.getAvailableConstraints());
            ...
            BtrPlaceVJobBuilder.LOGGER.debug("No constraints to load");
        }
        return c;
    }
}
